...
func NewCreateCommand() *cobra.Command {
	...
	cmd.Flags().StringArrayVar(&opts.scope, "scope", []string{"kafka-all"},
...
func runCreate(opts *options) error {
	...
	println("Creating service account with following permissions: %v", opts.scope)
