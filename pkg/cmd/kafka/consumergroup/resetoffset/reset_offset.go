...
var validator consumergrouputil.Validator
...
func NewResetOffsetConsumerGroupCommand(f *factory.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			if opts.value == "" && (opts.offset == consumergrouputil.OffsetAbsolute || opts.offset == consumergrouputil.OffsetTimestamp) {
	...
	flagutil.EnableStaticFlagCompletion(cmd, "offset", consumergrouputil.ValidOffsets)
...
func runCmd(opts *options) error {
	...
	if opts.offset == consumergrouputil.OffsetAbsolute || opts.offset == consumergrouputil.OffsetTimestamp {
