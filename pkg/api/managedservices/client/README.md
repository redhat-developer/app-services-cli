...
*DefaultApi* | [**CreateServiceAccount**](docs/DefaultApi.md#createserviceaccount) | **Get** /api/managed-services-api/v1/kafkas/serviceAccount | Create a kafka service account
