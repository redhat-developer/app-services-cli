...
*/
func (a *DefaultApiService) CreateServiceAccount(ctx _context.Context, serviceAccountRequest ServiceAccountRequest) (ServiceAccount, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ListCloudProviderRegionsOpts Optional parameters for the method 'ListCloudProviderRegions'
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The id of record
 * @param optional nil or *ListCloudProviderRegionsOpts - Optional Parameters:
 * @param "Page" (optional.String) -  Page index
 * @param "Size" (optional.String) -  Number of items in each page
@return CloudRegionList
*/
func (a *DefaultApiService) ListCloudProviderRegions(ctx _context.Context, id string, localVarOptionals *ListCloudProviderRegionsOpts) (CloudRegionList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/managed-services-api/v1/cloud_providers/{id}/regions"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")), -1)
...
// ListCloudProvidersOpts Optional parameters for the method 'ListCloudProviders'
type ListCloudProvidersOpts struct {
	Page optional.String
	Size optional.String
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ListCloudProvidersOpts - Optional Parameters:
 * @param "Page" (optional.String) -  Page index
 * @param "Size" (optional.String) -  Number of items in each page
@return CloudProviderList
*/
func (a *DefaultApiService) ListCloudProviders(ctx _context.Context, localVarOptionals *ListCloudProvidersOpts) (CloudProviderList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/managed-services-api/v1/cloud_providers"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
