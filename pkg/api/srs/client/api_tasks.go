 ...
 * @return ApiGetTaskRequest
 */
func (a *TasksApiService) GetTask(ctx _context.Context, taskId string) ApiGetTaskRequest {
	return ApiGetTaskRequest{
		ApiService: a,
		ctx: ctx,
		taskId: taskId,
 ...
 * @return Task
 */
func (a *TasksApiService) GetTaskExecute(r ApiGetTaskRequest) (Task, *_nethttp.Response, error) {
	var (
 ...
 * @return []Task
 */
func (a *TasksApiService) GetTasksExecute(r ApiGetTasksRequest) ([]Task, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
