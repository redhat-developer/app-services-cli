...
// SubscriptionCommonFieldsAllOf struct for SubscriptionCommonFieldsAllOf
type SubscriptionCommonFieldsAllOf struct {
...
func NewSubscriptionCommonFieldsAllOf(managed bool) *SubscriptionCommonFieldsAllOf {
	this := SubscriptionCommonFieldsAllOf{}
...
type NullableSubscriptionCommonFieldsAllOf struct {
	value *SubscriptionCommonFieldsAllOf
	isSet bool
}

func (v NullableSubscriptionCommonFieldsAllOf) Get() *SubscriptionCommonFieldsAllOf {
	return v.value
}

func (v *NullableSubscriptionCommonFieldsAllOf) Set(val *SubscriptionCommonFieldsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionCommonFieldsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionCommonFieldsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionCommonFieldsAllOf(val *SubscriptionCommonFieldsAllOf) *NullableSubscriptionCommonFieldsAllOf {
	return &NullableSubscriptionCommonFieldsAllOf{value: val, isSet: true}
}

func (v NullableSubscriptionCommonFieldsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionCommonFieldsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
