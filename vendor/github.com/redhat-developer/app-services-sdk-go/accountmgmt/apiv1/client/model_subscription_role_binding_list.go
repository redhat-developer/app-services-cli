...
// SubscriptionRoleBindingList struct for SubscriptionRoleBindingList
type SubscriptionRoleBindingList struct {
	Kind string `json:"kind"`
	Page int32 `json:"page"`
	Size int32 `json:"size"`
	Total int32 `json:"total"`
	Items []SubscriptionRoleBinding `json:"items"`
}
...
func NewSubscriptionRoleBindingList(kind string, page int32, size int32, total int32, items []SubscriptionRoleBinding) *SubscriptionRoleBindingList {
	this := SubscriptionRoleBindingList{}
	this.Kind = kind
	this.Page = page
	this.Size = size
	this.Total = total
...
func (o SubscriptionRoleBindingList) MarshalJSON() ([]byte, error) {
...
type NullableSubscriptionRoleBindingList struct {
	value *SubscriptionRoleBindingList
	isSet bool
}

func (v NullableSubscriptionRoleBindingList) Get() *SubscriptionRoleBindingList {
	return v.value
}

func (v *NullableSubscriptionRoleBindingList) Set(val *SubscriptionRoleBindingList) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionRoleBindingList) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionRoleBindingList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionRoleBindingList(val *SubscriptionRoleBindingList) *NullableSubscriptionRoleBindingList {
	return &NullableSubscriptionRoleBindingList{value: val, isSet: true}
}

func (v NullableSubscriptionRoleBindingList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionRoleBindingList) UnmarshalJSON(src []byte) error {
	v.isSet = true
