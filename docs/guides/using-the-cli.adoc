...
You can create a topic in the current Kafka instance with the `rhoas kafka topic create` command.
...
You can update the number of partitions, number of replicas and retention period for an existing Kafka topic with `rhoas kafka topic update`:
