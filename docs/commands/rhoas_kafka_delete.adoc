...
= [[ref-rhoas-kafka-delete_{context}]]rhoas kafka delete
...
== Options
      ...
      `--id` _string_::   Unique ID of the Kafka instance you want to delete. If not set, the current Kafka instance will be used.
