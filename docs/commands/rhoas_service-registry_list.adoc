...
List all the Service Registry instances for your account with the ability to paginate over the results.
...
....
  ...
  -o, --output string   Format in which to display the Service Registry instances. Choose from: "json", "yml", "yaml".
