...
....
      --api-gateway string    URL of the API gateway. The value can be the URL or an alias. Valid aliases are: production|staging|integration|development. (default "https://api.openshift.com")
