...
ifdef::env-github,env-browser[]
* link:rhoas_kafka_acl_delete.adoc#rhoas-kafka-acl-delete[rhoas kafka acl delete]	 - List all Kafka ACL rules.
endif::[]
ifdef::pantheonenv[]
* link:{path}#ref-rhoas-kafka-acl-delete_{context}[rhoas kafka acl delete]	 - List all Kafka ACL rules.
endif::[]
