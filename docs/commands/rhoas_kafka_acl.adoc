...
ifdef::env-github,env-browser[]
* link:rhoas_kafka_acl_admin.adoc#rhoas-kafka-acl-admin[rhoas kafka acl admin]	 - Give admin rights to the account
endif::[]
ifdef::pantheonenv[]
* link:{path}#ref-rhoas-kafka-acl-admin_{context}[rhoas kafka acl admin]	 - Give admin rights to the account
endif::[]
