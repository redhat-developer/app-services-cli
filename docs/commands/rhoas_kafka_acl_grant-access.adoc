...
$ rhoas kafka acl grant-access --consumer --user user_name --topic "*" --group "*" --instance-id c5hv7iru4an1g84pogp0
...
$ rhoas kafka acl grant-access --producer --consumer --user user_name --topic "*" --group "*"
