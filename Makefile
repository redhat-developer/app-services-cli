...
openapi/generate:
	openapi-generator-cli generate -i openapi/managed-services-api.yaml -g go --package-name client -p="generateInterfaces=true" --ignore-file-override=$$(pwd)/.openapi-generator-ignore -o ${managedservices_client_dir}
	openapi-generator-cli validate -i openapi/managed-services-api.yaml
	# generate mock
	moq -out ${managedservices_client_dir}/default_api_mock.go ${managedservices_client_dir} DefaultApi
